...
class VisionTransformerIJEPA(nn.Module):
    """ Vision Transformer """
    def __init__(
        self,
        img_size=[224],
    ...
    def convert_to_expected_dim(self, inputs_):
        # print(f"Before convert: {inputs_.shape}")
        # reshape the outputs to desired shape (N x H*W X C -> N x C x H x W)
        ...
        # print(f"After convert: {inputs_.shape}")
        return inputs_

_base_ = [
    '../_base_/models/upernet_ijepa.py', '../_base_/datasets/polyp.py',
...
model = dict(
    ...
    pretrained='/mnt/quanhd/ijepa_endoscopy_pretrained/splitted_target_encoder_jepa-ep500-non-crop.pth.tar',
    backbone=dict(
        type='IJEPA',
        img_size=(256, 256),
        patch_size=16,
